...
export const FilePenLineIcon = (props) => (
...
export const TwitterIcon = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M22 4s-.7 2.1-2 3.4c1.6 1.4 3.3 4.9 3.3 4.9s-1.4-.6-2.8-.9c-1.2 2.2-2.7 3.8-4.5 5.2-1.9 1.4-4.4 2.1-6.7 2.1-1.2 0-2.5-.2-3.8-.6s-2.5-1-3.6-1.8c-1.1-.8-2-1.8-2.8-3.1s-1.1-2.8-1.1-4.5c0-.4.1-.8.2-1.2.2-.4.4-.8.7-1.1s.6-.6.9-.9c.3-.3.7-.5 1-.6s.6-.2 1-.2c.3 0 .6 0 .9.1s.6.1.9.2c.3.1.6.2.8.4s.5.3.7.5c.2.2.4.3.6.5s.4.3.5.4c.2.1.3.2.4.3.1.1.2.2.3.2s.2.1.3.1.2.1.3.1c.1 0 .2 0 .3-.1h.1s.1 0 .1-.1c0-.1 0-.2-.1-.3s-.1-.2-.2-.3c-.1-.1-.2-.2-.3-.3s-.2-.2-.4-.3-.3-.2-.4-.3-.3-.2-.4-.3s-.2-.2-.3-.3c-.1-.1-.2-.2-.2-.3s-.2-.2-.2-.3-.1-.2-.1-.3-.1-.2-.1-.3c0-.1 0-.2 0-.3s0-.2 0-.3c0-.1 0-.2.1-.3s.1-.2.1-.3.1-.2.2-.3c.1-.1.2-.2.2-.3s.2-.2.3-.3.2-.2.3-.2c.1 0 .2-.1.3-.1s.2-.1.3-.1.2-.1.3-.1.3 0 .4-.1.3 0 .4-.1.3 0 .4-.1.2 0 .3 0h.3c.1 0 .3 0 .4 0h.4c.1 0 .3 0 .4 0h.4c.1 0 .3 0 .4 0h.4c.1 0 .3 0 .4 0h.3c.1 0 .3 0 .4 0h.4c.1 0 .3 0 .4 0h.4c.1 0 .3 0 .4 0h.4c.2 0 .3 0 .5 0h.4c.2 0 .3 0 .5 0h.4c.2 0 .3 0 .5 0h.4c.2 0 .4 0 .5 0h.4c.2 0 .4 0 .5 0h.4c.2 0 .4 0 .5 0h.4c.1 0 .3 0 .4 0h.4c.1 0 .3 0 .4 0h.4c.1 0 .3 0 .4 0Z"/></svg>
);
