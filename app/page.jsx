                        ...
                        <div className="container mx-auto px-6">
                            ...
                            <div className="grid md:grid-cols-2 gap-8">
                                ...
                                <div className="card p-8 rounded-xl">
                                    <p className="text-slate-300 mb-6">"I thought my laptop was gone forever after I left it in the lab. I reported it here and got a notification the next day! I'm so grateful for this platform."</p>
                                    <div className="flex items-center">
                                        <img src="https://i.pravatar.cc/150?img=1" alt="Student photo" className="w-12 h-12 rounded-full mr-4" />
                                        <div>
                                            <p className="text-white font-bold">Sarah Johnson</p>
                                            <p className="text-sky-400 text-sm">Computer Science Student</p>
                                        </div>
                                    </div>
                                </div>
                                {/* Testimonial 2 */}
                                <div className="card p-8 rounded-xl">
                                    <p className="text-slate-300 mb-6">"Finding a wallet and not knowing who it belongs to is stressful. I posted it on the portal, and the owner contacted me within hours. It was so easy and efficient."</p>
                                    <div className="flex items-center">
                                        <img src="https://i.pravatar.cc/150?img=32" alt="Student photo" className="w-12 h-12 rounded-full mr-4" />
                                        <div>
                                            <p className="text-white font-bold">Mike Chen</p>
                                            <p className="text-sky-400 text-sm">Business Administration Student</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
